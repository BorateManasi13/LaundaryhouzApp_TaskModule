...
public class PieceCategoryGarmentsAdapter extends BaseExpandableListAdapter
{
    private Context context;
    private List<CategoryGarments> categoryGarments = new ArrayList<>();
    private OnPieceImageClickListener onImageClickListener;

    public PieceCategoryGarmentsAdapter(Context context, List<CategoryGarments> categoryGarments, OnPieceImageClickListener onImageClickListener) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        PieceChildGarmentsAdapter pieceChildGarmentsAdapter = new PieceChildGarmentsAdapter(context, categoryGarments.get(groupPosition).childGarmentsList,onImageClickListener);
        childHolder.horizontalListView.setAdapter(pieceChildGarmentsAdapter);
