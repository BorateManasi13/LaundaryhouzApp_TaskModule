...
public class SelectedClotheAdapter extends RecyclerView.Adapter<SelectedClotheAdapter.ViewHolder>
{
    ...
    public SelectedClotheAdapter(List<SelectedClothe> selectedClotheList, Context context, OnItemClick mCallback) {
